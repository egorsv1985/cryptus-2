...
export function deliveryOption() {
	let delivery = document.querySelectorAll(".form-body-basket__delivery");
	const del = document.getElementById("delivery");
	const selfDelivery = document.getElementById("self-delivery");
		...
		item.addEventListener('click', () => {
			if (delivery) {
				...
				if(item.classList.contains('del')) {
					...
					selfDelivery.style.display = "none";
				}
				else if (item.classList.contains('selfDelivery')) {
					item.classList.add('active')
					del.style.display = "none";
					selfDelivery.style.display = "grid";
				}
				else {
					del.style.display = "grid";
					selfDelivery.style.display = "none";
